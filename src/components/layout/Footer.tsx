      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-5">
            <a
              href="https://x.com/shinro_xyz"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Follow us on X"
              className="text-shinro-muted hover:text-shinro-accent transition-all duration-300 hover:drop-shadow-[0_0_8px_rgba(59,130,246,0.5)]"
            >
            ...
            <a
              href="https://github.com/shinro-xyz"
              target="_blank"
              rel="noopener noreferrer"
